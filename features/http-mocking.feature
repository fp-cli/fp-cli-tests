    ...
    And that HTTP requests to https://api.finpress.org/core/version-check/1.7/ will respond with:
...

      {
        "offers": [
            {
                "response": "latest",
                "download": "https:\/\/downloads.finpress.org\/release\/finpress-999.9.9.zip",
                "locale": "en_US",
                "packages": {
                    "full": "https:\/\/downloads.finpress.org\/release\/finpress-999.9.9.zip",
                    "no_content": "https:\/\/downloads.finpress.org\/release\/finpress-999.9.9-no-content.zip",
                    "new_bundled": "https:\/\/downloads.finpress.org\/release\/finpress-999.9.9-new-bundled.zip",
                    "partial": false,
                    "rollback": false
                },
                "current": "999.9.9",
