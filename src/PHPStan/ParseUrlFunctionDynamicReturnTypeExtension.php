...
/**
 * Set return type of \FIN_CLI\Utils\parse_url().
 *
 ...
 *
 * phpcs:disable FinPress.FIN.AlternativeFunctions.parse_url_parse_url
 */
...
final class ParseUrlFunctionDynamicReturnTypeExtension implements \PHPStan\Type\DynamicFunctionReturnTypeExtension {
	...
	public function isFunctionSupported( FunctionReflection $functionReflection ): bool {
		return $functionReflection->getName() === 'FIN_CLI\Utils\parse_url';
	}
